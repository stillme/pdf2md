...
def cache_dir() -> Path:
    override = os.environ.get("PDFVAULT_CACHE_DIR")
    base = Path(override) if override else Path.home() / ".cache" / "pdfvault"
    base.mkdir(parents=True, exist_ok=True)
    return base


def cache_enabled() -> bool:
    return os.environ.get("PDFVAULT_CACHE", "") == "1"
...
def cached_call(
    ...
    **extra,
    ...
    """Run fn() with caching when PDFVAULT_CACHE=1; otherwise just call fn()."""
